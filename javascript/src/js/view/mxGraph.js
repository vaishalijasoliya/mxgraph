 ...
 *
 * Specifies the <mxImage>[] to be returned by <getBackgroundImages>. Default
 * is [].
 *
 * Example:
 *
 * (code)
 * var img1 = new mxImage('http://www.example.com/maps/examplemap.jpg', 1024, 768, 0, 0);
 * var img2 = new mxImage('http://www.example.com/maps/examplemap.jpg', 1024, 768, 1123, 0);
 * var imgs = [img1, img2];
 *
 * graph.setBackgroundImages(imgs);
 * graph.view.validate();
 * (end)
 */
mxGraph.prototype.backgroundImages = [];
...
mxGraph.prototype.fit = function (
  ...
  if (this.container != null) {
    ...
    if (bounds.width > 0 && bounds.height > 0) {
      ...
      // Fits to the size of the background images if required
      if (this.backgroundImages.length > 0) {
        w2 = Math.max(w2, this.backgroundImages[0].width - bounds.x / s);
        h2 = Math.max(h2, this.backgroundImages[0].height - bounds.y / s);
      }
 ...
 *
 * Returns the <backgroundImages> as an <mxImage>[].
 */
mxGraph.prototype.getBackgroundImages = function () {
 ...
 *
 * Sets the new <backgroundImages>.
 *
 * Parameters:
 *
 * images - [new <mxImage>, new <mxImage>] to be used for the background.
 */
mxGraph.prototype.setBackgroundImages = function (images) {
